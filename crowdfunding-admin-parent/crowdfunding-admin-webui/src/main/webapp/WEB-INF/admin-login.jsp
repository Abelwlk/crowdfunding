	...
	<div class="container">
		...
		<form action="security/do/login.html" method="post" class="form-signin" role="form">
			...
			<div class="form-group has-success has-feedback">
				<input type="text" name="loginAcct" class="form-control" value="admin" id="inputSuccess4"
					placeholder="请输入登录账号" autofocus> <span
					class="glyphicon glyphicon-user form-control-feedback"></span>
			</div>
			<div class="form-group has-success has-feedback">
				<input type="text" name="userPswd" class="form-control" value="123456" id="inputSuccess4"
